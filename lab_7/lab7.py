...
#assign bands
source = r"C:\Brar-online-GEOG676-fall2025\Brar-online-GEOG676-fall2025\lab_7"
...
composite = arcpy.CompositeBands_management([band1, band2, band3, band4], source + r"\output_combined.tif")
